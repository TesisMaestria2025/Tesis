...
Original file is located at
    https://colab.research.google.com/drive/1LUfGVzhDhgUx5ZD_dH1vwKUt4XX9rBMR
"""
...
model = tf.keras.Sequential([
    tf.keras.layers.GRU(50, activation='relu', return_sequences=False, input_shape=(sequence_length, 1)),
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('Overfitting_GRU.png')
plt.show()
